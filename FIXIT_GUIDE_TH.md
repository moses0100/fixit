...
การกู้คืนรหัสผ่านใช้ OTP 6 หลัก ส่งผ่าน SMTP และรหัสมีอายุ 10 นาที ใช้ได้ครั้งเดียว และกรอกผิดได้ไม่เกิน 5 ครั้ง

ก่อนทดสอบส่งอีเมลจริง ให้เปิด MySQL ใน XAMPP แล้วรัน `php artisan migrate` จากนั้นตั้งค่าใน `.env` ดังนี้
...
MAIL_PASSWORD=Google App Password 16 หลัก
MAIL_FROM_ADDRESS=อีเมลผู้ส่ง
MAIL_FROM_NAME=FixIT
```

ถ้าใช้ Gmail ให้เปิดการยืนยันแบบ 2 ขั้นตอนและสร้าง App Password สำหรับโปรเจกต์ ห้ามใช้รหัสผ่าน Gmail หลัก และห้ามนำค่าใน `.env` ขึ้น Git
