...
<button type="submit" class="btn btn-primary w-100">เข้าสู่ระบบ →</button><p class="small text-center mt-4 mb-0">ยังไม่มีบัญชี? <a href="{{ route('register') }}">สมัครสมาชิก</a></p>
